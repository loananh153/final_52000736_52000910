                    ...
                    <div class="span9">
                        ...
                        <div class="module">
                            <div class="module-head" style = "background: #FF4C29; ">
                                <h3 style = "color: white">Thông tin chi tiết</h3>
                            </div>
                        ...
                        <?php
                            ...
                            $row=$result->fetch_assoc();    
                                ...
                                echo "<b><u>Mã số sinh viên/ Tên đăng nhập :</u></b> ".$rno."<br><br>";
                                echo "<b><u>Email:</u></b> ".$email."<br><br>";
                                echo "<b><u>Số điện thoại:</u></b> ".$mobno."<br><br>"; 
                            ?>
                            
                        <a href="student.php" class="btn btn-primary" style = "background: #FF4C29; color: white">Quay lại</a>                             
                               </div>
                           </div>
                        </div>
                    </div>
